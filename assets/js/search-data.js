...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Some of my projects, divided into work and fun.",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "A summary of my academic background and research experience. For the complete overview, download my full CV (PDF).",
          section: "Navigation",
          handler: () => {
